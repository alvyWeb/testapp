...
const Complete = ({ standings, setStandings }) => {
  ...
  const everyThing = [
    {
      ...
      /*SOLO*/
      soloHeadTitle: "פארק הירקון, תל אביב | מגרש #1",
      soloDate: "02/24/2023",
      soloTime: "14:00",
      soloComments: "26 הודעות",
      soloPlayerImg: "../user-Image/a1.png",
      soloPlayerCountry: "../flags/br.png",
      soloPlayerName: "מנדלר ת.",
      soloPlayerRank: "(פרו)",
      soloCurrentScore: "1 - 3",
      soloPreviousScore1: "1 - 0",
      soloPreviousScore2: "1 - 2",
      soloPreviousScore3: "4 - 3",
      soloOpPlayerImg: "../user-Image/a2.png",
      soloOpPlayerCountryImg: "../flags/br.png",
      soloOpPlayerImg2: "גורן ש.",
      soloOpPlayer2Rank: "(מוצקין)",
    },
    {
      /*SQUAD*/
      squadHeadTitle: "פארק הירקון, תל אביב | מגרש #1",
  ...
  return (
    <main>
      <div className="enrollmentN everything_new">
