  ...
  const upGames = [
    {
      ...
      comment: "26 הודעות",
      fPlayerImg: "./user-Image/g2.png",
      fPlayerCountry: "./flags/br.png",
      mandler: "מנדלר ת.",
      mandlerRank: "(פרו)",
      sPlayerImg: "./user-Image/g1.png",
      sPlayerCountry: "./flags/br.png",
      ozy: "עוז י.",
      ozyRank: "(הקוסם)",
      vs: "VS",
      tPlayerImg: "./user-Image/g4.png",
      tPlayerCountry: "./flags/br.png",
      playerToffee: "../Stock/futuregamesmine/svg/toffee.svg",
      cImg: "../Stock/futuregamesmine/svg/red-c.svg",
      rPlayerImg: "./user-Image/g3.png",
      rPlayerCountry: "./flags/br.png",
      toffee: "../Stock/futuregamesmine/svg/tennis.svg",
      goren: "גורן ש.",
      gorenRank: "(קשה)",
      peenName: "פן נ.",
      peenRank: "(פנתר)",
      sTeamTitle: "פארק הירקון, תל אביב | מגרש #2",
      chatImg: "./user-Image/g1.png",
      chatTitle: "מתוך הצ’אט:",
      chatText: "הולך להיות משחק משוגע לורם איפסום לורם איפס...",
      playMatch: "2",
      matchScore: "1.62",
      sTeamMatchplay: "1",
      ...
      soloComment: "26 הודעות",
      solofImg: "./user-Image/g4.png",
      soloFCountry: "./flags/br.png",
      soloFName: "מנדלר ת.",
      soloFRank: "(פרו)",
      soloPlayerImg: "./user-Image/g1.png",
      soloPlayerCountry: "./flags/br.png",
      soloPlayerToffee: "../Stock/futuregamesmine/svg/toffee.svg",
      soloChatImg: "./user-Image/g1.png",
      ...
      soloChatTitle: "מתוך הצ’אט:",
      soloChatText: "הולך להיות משחק משוגע לורם איפסום לורם איפס...",
    },
    {
      squadTitle: "פארק הירקון, תל אביב | מגרש #2",
      calenderImg: "../Stock/futuregamesmine/svg/calender.svg",
      ...
      commentImg: "../Stock/enrollment/svg/comment.svg",
      comment: "26 הודעות",
      fPlayerImg: "./user-Image/g4.png",
      fPlayerCountry: "./flags/br.png",
      mandler: "מנדלר ת.",
      mandlerRank: "(פרו)",
      sPlayerImg: "./user-Image/g3.png",
      sPlayerCountry: "./flags/br.png",
      ozy: "עוז י.",
      ozyRank: "(הקוסם)",
      vs: "VS",
      tPlayerImg: "./user-Image/g2.png",
      tPlayerCountry: "./flags/br.png",
      playerToffee: "../Stock/futuregamesmine/svg/toffee.svg",
      cImg: "../Stock/futuregamesmine/svg/red-c.svg",
      rPlayerImg: "./user-Image/g1.png",
      rPlayerCountry: "./flags/br.png",
      toffee: "../Stock/futuregamesmine/svg/tennis.svg",
      goren: "גורן ש.",
      gorenRank: "(קשה)",
