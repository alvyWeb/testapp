      ...
      <div className="propyl_container">
        ...
        <div className="my_account">
          ...
          <div className="award_blocks">
            <div className={`headpart ${isOpen ? "expanded" : ""}`} onClick={() => setIsOpen(!isOpen)}>
              <p>פרסים שהושגו</p>
            ...
            <div className={`headbody ${isOpen ? "open" : "closed"}`}>
          ...
          <div className="statics_blocks">
            <div className={`statheadpart ${isOpen ? "expanded" : ""}`} onClick={() => setIsOpen(!isOpen)}>
